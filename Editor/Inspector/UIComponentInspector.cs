...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class UIComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty m_InstanceHUDRoot = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                EditorGUILayout.PropertyField(m_InstanceHUDRoot);
        ...
        private void OnEnable()
        {
            ...
            m_InstanceHUDRoot = serializedObject.FindProperty("m_InstanceHUDRoot");
