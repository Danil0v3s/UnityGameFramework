...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private Transform m_InstanceHUDRoot = null;
        ...
        public Transform InstanceHUDRoot
        {
            get
            {
                return m_InstanceHUDRoot;
            }
        }
        ...
        /// <returns>是否增加界面组成功。</returns>
        public bool AddUIGroup(string uiGroupName, int depth, bool isHUD = false)
        {
            ...
            transform.SetParent(isHUD ? m_InstanceHUDRoot : m_InstanceRoot);
            transform.localScale = Vector3.one;
